  ...
  describe("Creating migration table", () => {
    ...
    it("should create migration table with valid params", () => {
      return new Promise((resolve, reject) => {
        MigrationTable.create(dynamodb, randomTableName).then(
          (migrationTable) => {
    ...
    it("should put file names into migration table and validate they exist", () => {
      ...
      return MigrationTable.create(dynamodb, randomTableName).then(() => {
        return migrationTable.insert(fileName).then((id) => {
          return migrationTable.shouldRun(fileName).then((shouldRun) => {
      ...
      return MigrationTable.create(dynamodb, randomTableName).then(() => {
        return migrationTable
          ...
          .then((id) => {
            ...
            return _queryFileByName(dynamodb, randomTableName, fileName).then(
              (data) => {
